---
name: notemdpro-test-driven-development
description: "Use this skill to make safe changes to NoteMD Pro core utilities by protecting them with the project’s regression-test workflow."
---
...
- `notemdpro-system-architecture` — to understand the codepaths under test
- `skill-creator` — for broader skill evaluation and iteration workflows
