---
name: notemdpro-text-translator
description: "Use this skill to translate markdown notes to another language while preserving formatting, images, and special elements."
---
...
- `notemdpro-content-generator` — when translation follows generation
- `obsidian-markdown` — for markdown preservation guidance
