---
name: obsidian-plugin-code-quality
description: Use this skill when reviewing Obsidian plugin code for sample-code cleanup, DOM safety, requestUrl usage, platform compatibility, async patterns, and general production-readiness.
---

# Obsidian Plugin Code Quality

Use this skill when hardening plugin code for release quality, security, mobile compatibility, and idiomatic Obsidian API usage.
