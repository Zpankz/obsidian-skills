---
name: obsidian-plugin-submission
description: Use this skill when preparing an Obsidian plugin for release, validating manifest metadata, checking naming constraints, assembling release assets, or submitting to the community plugins directory.
---

# Obsidian Plugin Submission

Use this skill when you are close to release and need to validate metadata, packaging, testing, and community-plugin submission requirements.
