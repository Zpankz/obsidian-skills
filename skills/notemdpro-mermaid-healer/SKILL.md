---
name: notemdpro-mermaid-healer
description: "Use this skill to repair Mermaid diagrams with syntax or structural issues such as broken arrows, malformed subgraphs, or unquoted labels."
---
...
- `notemdpro-mermaid-summarizer` — when the task also involves Mermaid generation
- `obsidian-mermaid` — for complementary Mermaid authoring guidance
