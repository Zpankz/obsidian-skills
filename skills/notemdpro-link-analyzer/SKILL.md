---
name: notemdpro-link-analyzer
description: "Use this skill to insert wiki-links across markdown notes so core concepts become part of an interconnected knowledge graph."
---
...
- `notemdpro-concept-extractor` — to derive concepts before linking them
- `obsidian-links` — for complementary wikilink validation guidance
