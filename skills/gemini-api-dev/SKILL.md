---
name: gemini-api-dev
description: Build applications with Gemini API, multimodal content, function calling, and structured outputs. Covers google-genai SDKs for Python, TypeScript, Java, and Go.
---

# Gemini API Development Skill

Use this skill when implementing or updating Gemini-powered application code and you need current model, SDK, and capability guidance across Python, TypeScript, Go, or Java.
...
## Related skills
- `gemini-live-api-dev` — for real-time streaming, voice, and session-oriented Live API work
- `gemini-interactions-api` — for the newer Interactions API and agent-style request flows
- `gemini-image-skill` — for document and slide image generation inside Obsidian workflows
- `viva-examiner` — for an Obsidian plugin example built on Gemini Live voice workflows
- `viva-llm` — for an Obsidian plugin example that mixes Gemini with broader provider orchestration

## Gemini Live API

For real-time, bidirectional audio/video/text streaming with the Gemini Live API, use the local **`gemini-live-api-dev`** skill. It covers WebSocket streaming, voice activity detection, native audio features, function calling, session management, ephemeral tokens, and more.
