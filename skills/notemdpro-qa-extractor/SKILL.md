---
name: notemdpro-qa-extractor
description: "Use this skill to extract targeted or verbatim answers to specific questions from longer source text, with optional translation of the extracted text."
---
...
- `notemdpro-selection-processor` — for narrower extraction over highlighted passages
- `notemdpro-web-researcher` — when answers need external context
