---
name: notemdpro-system-architecture
description: "Use this skill to understand NoteMD Pro module dependencies, call chains, and the FileSystemPort-based architecture of the pipeline."
---
...
- `notemdpro-test-driven-development` — when architecture understanding leads to safe refactors
- `skill-creator` — for improving or restructuring imported skill families
