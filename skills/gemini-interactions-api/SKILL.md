...
description: Use the Gemini Interactions API for stateful chat, streaming, function calling, and agent orchestration. Trigger on Interactions API usage or migrating from generateContent.
---

# Gemini Interactions API Skill

Use this skill when building against the Gemini Interactions API for stateful conversations, streaming, background execution, tools, or agent-style orchestration in Python or TypeScript.
...
## Related skills
- `gemini-api-dev` — for broader Gemini API and SDK guidance outside the Interactions API
- `gemini-live-api-dev` — for realtime bidirectional streaming via Gemini Live
- `gemini-image-skill` — for Gemini-powered image generation in document and slide workflows
- `viva-llm` — for an Obsidian plugin example that mixes Gemini models with vault-integrated chat and tools
