---
name: obsidian-plugin-memory-management
description: Use this skill when implementing or reviewing Obsidian plugin lifecycle code involving views, event registration, DOM listeners, intervals, MarkdownRenderer components, or unload cleanup. Focuses on leak prevention and correct resource ownership.
---

# Obsidian Plugin Memory Management

Use this skill when a plugin feature registers events, creates views, manages components, or risks leaking resources across reloads.
