---
name: obsidian-plugin-type-safety
description: Use this skill when writing or reviewing TypeScript in an Obsidian plugin and you need safe narrowing for TFile/TFolder, better typing than any, or cleaner const/let usage.
---
