---
name: notemdpro-web-researcher
description: "Use this skill to gather web research context with Tavily or DuckDuckGo before content generation or summarization."
---
...
- `notemdpro-content-generator` — when research feeds document generation
- `defuddle` — for complementary clean-markdown extraction from web pages
