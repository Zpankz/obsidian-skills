---
name: notemdpro-content-generator
description: "Use this skill to generate comprehensive markdown content from a title or thin note, optionally enriched with web research context."
---
...
See [notemdpro-mermaid-healer](../notemdpro-mermaid-healer/SKILL.md) for full Mermaid fixing code.
...
- `notemdpro-web-researcher` — to enrich generation with external context
- `notemdpro-mermaid-healer` — to clean up generated Mermaid output
- `notemdpro-formula-healer` — to repair generated math formatting
