---
name: notemdpro-selection-processor
description: "Use this skill to process only a selected slice of text instead of a whole file, saving tokens and enabling targeted AI operations."
---
...
- `notemdpro-qa-extractor` — for question-targeted extraction
- `notemdpro-concept-extractor` — for concept extraction on partial content
