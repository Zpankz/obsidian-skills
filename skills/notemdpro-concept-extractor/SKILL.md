---
name: notemdpro-concept-extractor
description: "Use this skill to extract core knowledge concepts, technical terms, and specialized vocabulary from a document to build a wiki-linked knowledge graph."
---
...
- `notemdpro-link-analyzer` — to turn extracted concepts into wiki-links
- `notemdpro-selection-processor` — for narrower extraction over a selected passage
