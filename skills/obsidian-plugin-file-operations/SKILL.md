---
name: obsidian-plugin-file-operations
description: Use this skill when an Obsidian plugin reads, edits, moves, trashes, or looks up files and folders. Covers Editor API versus Vault API, Vault.process, FileManager helpers, view access, and path normalization.
---

# Obsidian Plugin File Operations

Use this skill when plugin code touches notes, frontmatter, paths, or vault lookups and you need the safest Obsidian-native file APIs.
