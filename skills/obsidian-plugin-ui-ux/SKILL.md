...
- the issue is CSS, spacing, colors, or selectors → `obsidian-plugin-css-styling`
- the issue is shadcn component theming or variants → `obsidian-plugin-shadcn-styling`
- the issue is shadcn form/card/dialog composition → `obsidian-plugin-shadcn-composition`
